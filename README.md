...
**[BlogApp]** it is an application built with ruby on rails, that allows me to create blog posts, with like, comment functionality attached with each user. 
...
- Add the signup and signin features 
- Add the comments and likes features
